...
func show_plot(plot: Dictionary, is_claimable: bool, is_logged_in: bool) -> void:
	...
	# The button is visible only when the plot is claimable.
	# It remains disabled until the user is logged in.
